...
- **Доступ к XML-разметке**: Имеется возможность работы с низкоуровневой XML-разметкой, что позволяет реализовать функционал, не имплементированный в библиотеке.
- **Компенсация ошибок и недоработок**: Возможность переписывания методов на низкоуровневом уровне позволяет компенсировать ошибки и недоработки библиотеки.
